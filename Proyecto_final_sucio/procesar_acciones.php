...
elseif ($accion === 'eliminar') {
    ...
    $_SESSION['origen'] = $_POST['origen'] ?? "listar_incidencias.php"; // Guardamos la página de origen

    // Convertir los IDs a enteros antes de guardarlos en sesión
    ...
    error_log("IDs recibidos (POST): " . print_r($_POST['ids'], true));
    error_log("IDs almacenados en sesión: " . print_r($_SESSION['ids_a_eliminar'], true));

    
  

    // Si el usuario es administrador, va a eliminar.php, sino, a eliminar_incidencia.php
    if ($is_admin) {

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Obtiene y convierte el ID de la incidencia a un número entero para mayor seguridad
    ...
    if ($result->num_rows === 0) {
        header("Location: listar_incidencias.php?error=No puedes comentar en esta incidencia.");
        exit();
    }

    ...
    <div class="container">
        ...
        <?php if ($isAdmin == 1): ?>
            ...
            <div class="menu">
                ...
                <a href="listar_admin.php" class="menu-item"><i class="fa-solid fa-list"></i> Listar mis Incidencia</a>
                <a href="procesar_alerta.php" class="menu-item"><i class="fa-solid fa-list"></i> Listar Incidencias</a>

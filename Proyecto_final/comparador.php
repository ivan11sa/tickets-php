...
$tiempo_inicio_sesion = $_SESSION['start_time'] ?? time();
$tiempo_transcurrido = time() - $tiempo_inicio_sesion;
...
<body>
    <div class="container">
        ...
        <!-- Barra fija que muestra el tiempo transcurrido desde el inicio de sesión -->
        <div class="fixed-bar">
